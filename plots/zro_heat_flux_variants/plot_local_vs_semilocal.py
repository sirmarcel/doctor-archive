...
styles = {
    "jfan": {"color": red, "linestyle": dashed, "linewidth": 2},
    "jfan_mpnn": {"color": black, "linestyle": solid, "linewidth": 2},
}
...
for thermo, s in settings.items():
    ...
    plot_difference(ax, kappas["jfan_mpnn"], kappas["jfan"])

    setup_ax(ax, **s)
    ax.legend(loc="lower right", handlelength=5)

    savefig(fig, f"mic/fan_{thermo}.png")
