...
styles = {
    ...
    "jedges": {"color": cyan, "linestyle": solid, "linewidth": 2},
}
...
for thermo, s in settings.items():
    ...
    kappas = {
        j: data.sel(heat_flux=j)
        for j in ["jhardy", "jfan_mpnn", "junf", "jfan", "jedges"]
    }
    ...
    savefig(fig, f"all/m1_{thermo}.png")
    savefig(fig, img / f"gk/zro_hfs_all_m1_{thermo}.pdf")
